...
def setup_commands(app):
    ...
    def insert_test_data():
        ...
        valores = [{'id': 1, 'doctor_id':'1', 'speciality_id': 1, 'center_id':1,'calendar_id':1, },
                    ...
                    {'id': 13, 'doctor_id':'null', 'speciality_id': 2, 'center_id':2,'calendar_id':13, },
                    {'id': 14, 'doctor_id':'null', 'speciality_id': 2, 'center_id':2,'calendar_id':14, },
                    {'id': 15, 'doctor_id':'null', 'speciality_id': 3, 'center_id':2,'calendar_id':15, },
                    {'id': 16, 'doctor_id':'null', 'speciality_id': 3, 'center_id':2,'calendar_id':16, },
                    {'id': 17, 'doctor_id':'null', 'speciality_id': 1, 'center_id':3,'calendar_id':17, },
                    {'id': 18, 'doctor_id':'null', 'speciality_id': 1, 'center_id':3,'calendar_id':18, },
                    {'id': 19, 'doctor_id':'null', 'speciality_id': 2, 'center_id':3,'calendar_id':19, },
                    {'id': 20, 'doctor_id':'null', 'speciality_id': 2, 'center_id':3,'calendar_id':20, },
                    {'id': 21, 'doctor_id':'null', 'speciality_id': 3, 'center_id':3,'calendar_id':21, },
                    {'id': 22, 'doctor_id':'null', 'speciality_id': 3, 'center_id':3,'calendar_id':22, },
                    {'id': 23, 'doctor_id':'null', 'speciality_id': 4, 'center_id':3,'calendar_id':23, },
                    {'id': 24, 'doctor_id':'null', 'speciality_id': 4, 'center_id':3,'calendar_id':24, },
                    ]
        for valor in valores:
            appointment = Appointment()
