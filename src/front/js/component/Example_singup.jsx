...
export const ExampleSingUP= () => {
  ...
  <div class="form-outline mb-4">
    ...
    <label class="form-label" for="form2Example2">Your Rut</label>
  </div>
  <div class="form-outline mb-4">
    <input type="email" id="form2Example1" class="form-control" />
    <label class="form-label" for="form2Example1">Prevision</label>
  </div>
  ...
  <button type="button" class="btn btn-primary btn-block mb-4 justify-content-center">Sign UP</button>
  </div>
