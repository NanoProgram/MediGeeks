    ...
    <section id="services" style={{ opacity: 0.8 }}>
        <div class="card w-75 mb-3 mx-auto"style={cardStyle} >
            <div class="card-body text-center">
                ...
                <br />
                <h5 class="card-text text-black">Somos una empresa líder en el mercado, dedicada a brindar soluciones innovadoras y de alta calidad a nuestros clientes. Contamos con un equipo altamente capacitado y experimentado, compuesto por expertos en diversas áreas, quienes trabajan incansablemente para garantizar que nuestros productos y servicios cumplan con las necesidades y expectativas de nuestros clientes.
                    <br />
