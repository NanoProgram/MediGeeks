            ...
            <div className="col">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">
                            En <strong>MediGeeks</strong> la búsqueda de médicos y centros médicos permite a los pacientes buscar y seleccionar a su médico y centro médico preferido. <strong>MediGeeks</strong> puede incluir información como la especialidad del médico, la ubicación y la disponibilidad de citas.
                        </p>
                        <div style={{ textAlign: 'center' }}>
                            <a href="/singup">
                                <button className="btn btn-primary me-2" type="button">registrarse</button>
