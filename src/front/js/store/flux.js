  ...
  return {
    ...
    actions: {
      login: async (email, password) => {
        await fetch(
          "https://3001-nanoprogram-medigeeks-mww1bt06jmk.ws-us98.gitpod.io/api/login?email=${email}&password=${password}",
      ...
      saveData: async (calendarID) => {
        ...
        try {
          const response = await fetch(
            `https://3001-nanoprogram-medigeeks-mww1bt06jmk.ws-us98.gitpod.io/api/mediGeeks/appointments/${calendarID}`,
            {
              method: "PUT",
